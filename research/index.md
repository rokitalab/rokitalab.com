...
**TAPESTRY**: Tumor Alternative PEdiatric Splicing visualizaTion and queRYing (TAPESTRY) is our latest web application and API for exploring tumor-enriched junctions (TEJs) across pediatric brain tumors. 
TAPESTRY was developed by [Dr. Patricia Sullivan](https://rokitalab.com/labmembers/03-patricia-sullivan.html), with the underlying tumor-enriched junction data generated by [Dr. Ryan Corbett](https://rokitalab.com/labmembers/02-ryan-corbett.html), and AWS infrastructure support from [Dr. Chao Di](https://rokitalab.com/labmembers/10-chao-di.html).
Explore TAPESTRY <a href="https://tapestry.rokitalab.com/" target="_blank">here</a>
...
**OpenPedCan**: The pan-cancer expansion counterpart of OpenPBTA is the [Open Pediatric Cancer (OpenPedCan) Project](https://github.com/rokitalab/OpenPedCan-Project-CNH). OpenPedCan became the foundational data layer of the [NCI’s pediatric Molecular Targets Platform](https://moleculartargets.ccdi.cancer.gov/) and is used to support clinical trial decision-making for the [Pediatric Neuro-Oncology Consortium (PNOC)](https://pnoc.us/), therapeutic development, and discovery and translational research.
...
**Germline risk variants**: In collaboration with [Dr. Sharon Diskin](https://diskinlab.org/), our team characterizes patient and parental germlines to pinpoint pathogenic variants that [predispose](https://pubmed.ncbi.nlm.nih.gov/41271695/) patients to brain tumor development, offering new insights into how these variants influence tumor biology.
